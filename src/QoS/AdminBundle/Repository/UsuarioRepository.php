...
namespace QoS\AdminBundle\Repository;
...
class UsuarioRepository extends EntityRepository implements UserProviderInterface
{
    public function loadUserByUsername($username)
    {
        $q = $this
            ...
            ->select('u, r')
            ->leftJoin('u.rol', 'r')
            ->where('u.username = :username OR u.email = :username OR u.usernamecanonical = :username')
    ...
    public function getUserByIdUsername($text){
        $q = $this
            ->createQueryBuilder('u')
            ->select('u, r')
            ->leftJoin('u.rol', 'r')
            ->where('u.username = :username OR u.email = :username OR u.usernamecanonical = :username OR u.id = :username')
